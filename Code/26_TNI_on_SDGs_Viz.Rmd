...
fname <- paste0(dir.fig, '01main/SDG_score_chg_Bar_Icon_', today, '.jpg'); fname
...
fname <- paste0(dir.fig, '01main/SDG_score_chg_Bar_byGroup2grp_', today, '.jpg'); fname
ggsave(filename = fname, plot = last_plot(), width = 6, height = 8, units = 'in', dpi = 300)
```
...
fname <- paste0(dir.fig, '01main/SDG_score_count_Improved3_', today, '.jpg'); fname
...
### plot 
fname <- paste0(dir.fig, '01main/SDG_Index_Map_Baseline + Lockdown_', today, '.jpg'); fname
...
fname <- paste0(dir.fig, '01main/SDG_Index_chg_Map_', today, '.jpg'); fname
# jpeg(filename = fname, width=7, height=2.8, units="in", pointsize=18, res=300)
...
```{r - boxplot - change by 4 income group - fig ex2}
dfs_index_chg %>%
