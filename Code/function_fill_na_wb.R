...
# httns://ajitjohnson.com/replace-na-with-last-non-na-R/ 
# httns://rstudio-pubs-static.s3.amazonaws.com/261109_2b6c19cb807b444399e3c370f9c3d381.html 
...
function_fill_na_wb <- function(df, year_from = 1990) {
  dfs <- data.frame()
  ...
  plot <- dfs %>%
    ...
    ggplot()+
    geom_line(aes(x = year, y = value),    color = 'blue', linewidth = 6) +
    geom_line(aes(x = year, y = value_ks), color = 'red',  linewidth = 2) +
