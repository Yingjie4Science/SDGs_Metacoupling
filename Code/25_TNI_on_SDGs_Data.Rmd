...
rel_not_merge <- oft %>%
  ...
  dplyr::mutate(
    ...
    value_not = fromAll*0.001/pop, 
    ## 0 transfer under no-trade ## use 0.1 avoid 0, which cause problem in calculation later
    value_dst = fromDst/pop,
    value_ner = fromNer/pop,
    
    # value_rel = ifelse(-fromAll>0, -fromAll/pop, NA),      ## more out-flow, the better
    # value_not = ifelse(-fromAll>0, -fromAll*0.01/pop, NA), 
    # ## 0 transfer under no-trade ## use 0.1 avoid 0, which cause problem in calculation later
    # value_dst = ifelse(-fromDst>0, -fromDst/pop, NA),
    # value_ner = ifelse(-fromNer>0, -fromNer/pop, NA) 
