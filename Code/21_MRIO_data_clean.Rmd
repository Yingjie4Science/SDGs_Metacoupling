...
### - old list
xls.eora.ls.old <- list.files(path = paste0(dir.eora, '2021-08-05'), pattern = pattern, full.names = T);
...
inds <- unique(inds); 
inds.old <- inds
print(paste0('The total number of Eora indicators: ', length(inds.old)))
...
for (xls in xls.ls) {
  ...
  ### save plot
  fname <-paste0(dir.fig, 'footprint_heatmap/FT_HT_', iname, '_', yr, '_20220801.png'); print(fname)
