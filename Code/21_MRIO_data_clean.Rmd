...
### - ODA OECD
  ...
  See `ODA_data_prep.Rmd` in "./Data/data_01_raw/OECD_ODA/"

```{r}
ind <- 'ODA_OOF_total_matrix'
ind <- 'ODA_Infrastructure_matrix'
ind <- 'ODA_Agriculture_matrix'
ind <- 'ODA_Education_matrix'
ind <- 'ODA_Energy_matrix'
ind <- 'ODA_Food_matrix'
ind <- 'ODA_Water_matrix'
ind <- 'ODA_Biodiversity_matrix'
ind <- 'ODA_total_disbursements_matrix'
ind <- 'ODA_Health_matrix'
...
### - Portfolio Investment - IMF-CPIS

  See `CPIS_data_prep.Rmd` in "./Data/data_01_raw/IMF_CPIS/"
  
```{r}
### get the indicator name
ind <- 'CPIS_matrix'
yrs <- c(2000, 2005, 2010, 2015)
dir.i <- './Data/data_01_raw/IMF_CPIS/'
...
### - Bilateral Remittance Matrix - WB

  See `Remittance_data_prep.Rmd` in "./Data/data_01_raw/WB_Remittance/"
...
### - Inventor migration
  ...
  See `Inventor migration_data_prep.Rmd` in './Data/data_01_raw/Inventor migration files/'
...
### - High-skilled immigrants
  ...
  See `Immigrants_data_prep.Rmd` in './Data/data_01_raw/OECD_Immigrants/'
...
### - Refugee - UNHCR
  ...
  See `Refugee_data_prep.Rmd` in "./Data/data_01_raw/IMF_CPIS/"
  
```{r}
### get the indicator name
ind <- 'Refugee'
yrs <- c(2000, 2005, 2010, 2015)
dir.i <- './Data/data_01_raw/UNHCR_Refugee Data Finder/'
