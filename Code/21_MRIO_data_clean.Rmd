...
dir.shdb.detail <- './Data/data_02_intermediate/dt02_flows/eora/SHDB2019_135_renamed/'
pattern <- '^YJ_SHDB'
inds_ls <- list.files(path = dir.shdb.detail, pattern = pattern, full.names = T); inds_ls
